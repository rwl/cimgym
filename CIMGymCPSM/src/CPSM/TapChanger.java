 ...
 * <ul>
 *   <li>{@link CPSM.TapChanger#getRegulatingControl <em>Regulating Control</em>}</li>
 *   <li>{@link CPSM.TapChanger#getTransformerWinding <em>Transformer Winding</em>}</li>
 *   <li>{@link CPSM.TapChanger#getNormalStep <em>Normal Step</em>}</li>
 *   <li>{@link CPSM.TapChanger#getHighStep <em>High Step</em>}</li>
 *   <li>{@link CPSM.TapChanger#getStepPhaseShiftIncrement <em>Step Phase Shift Increment</em>}</li>
 *   <li>{@link CPSM.TapChanger#getNeutralStep <em>Neutral Step</em>}</li>
 *   <li>{@link CPSM.TapChanger#getLowStep <em>Low Step</em>}</li>
 *   <li>{@link CPSM.TapChanger#getTculControlMode <em>Tcul Control Mode</em>}</li>
 *   <li>{@link CPSM.TapChanger#getStepVoltageIncrement <em>Step Voltage Increment</em>}</li>
 *   <li>{@link CPSM.TapChanger#getType <em>Type</em>}</li>
 *   <li>{@link CPSM.TapChanger#getNeutralU <em>Neutral U</em>}</li>
 * </ul>
 * </p>
 *
 * @see CPSM.CPSMPackage#getTapChanger()
...
public interface TapChanger extends PowerSystemResource {
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.RegulatingControl#getTapChanger <em>Tap Changer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.CPSMPackage#getTapChanger_RegulatingControl()
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getRegulatingControl <em>Regulating Control</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.TransformerWinding#getTapChangers <em>Tap Changers</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.CPSMPackage#getTapChanger_TransformerWinding()
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getTransformerWinding <em>Transformer Winding</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.CPSMPackage#getTapChanger_NormalStep()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getNormalStep <em>Normal Step</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setHighStep(int)
	 * @see CPSM.CPSMPackage#getTapChanger_HighStep()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getHighStep <em>High Step</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.CPSMPackage#getTapChanger_StepPhaseShiftIncrement()
	 * @model dataType="CPSM.AngleDegrees" required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getStepPhaseShiftIncrement <em>Step Phase Shift Increment</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.CPSMPackage#getTapChanger_NeutralStep()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getNeutralStep <em>Neutral Step</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setLowStep(int)
	 * @see CPSM.CPSMPackage#getTapChanger_LowStep()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getLowStep <em>Low Step</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link CPSM.TransformerControlMode}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.CPSMPackage#getTapChanger_TculControlMode()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getTculControlMode <em>Tcul Control Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.CPSMPackage#getTapChanger_StepVoltageIncrement()
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getStepVoltageIncrement <em>Step Voltage Increment</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link CPSM.TapChangerKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.CPSMPackage#getTapChanger_Type()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getType <em>Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.CPSMPackage#getTapChanger_NeutralU()
	...
	/**
	 * Sets the value of the '{@link CPSM.TapChanger#getNeutralU <em>Neutral U</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
