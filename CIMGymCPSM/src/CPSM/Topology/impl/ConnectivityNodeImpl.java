 ...
 * <ul>
 *   <li>{@link CPSM.Topology.impl.ConnectivityNodeImpl#getTerminals <em>Terminals</em>}</li>
 *   <li>{@link CPSM.Topology.impl.ConnectivityNodeImpl#getMemberOf_EquipmentContainer <em>Member Of Equipment Container</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectivityNodeImpl extends IdentifiedObjectImpl implements ConnectivityNode {
	...
	public EList<Terminal> getTerminals() {
		if (terminals == null) {
			terminals = new EObjectWithInverseResolvingEList<Terminal>(Terminal.class, this, TopologyPackage.CONNECTIVITY_NODE__TERMINALS, CorePackage.TERMINAL__CONNECTIVITY_NODE);
		}
		return terminals;
	}
		...
		if (memberOf_EquipmentContainer != null && memberOf_EquipmentContainer.eIsProxy()) {
			...
			if (memberOf_EquipmentContainer != oldMemberOf_EquipmentContainer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TopologyPackage.CONNECTIVITY_NODE__MEMBER_OF_EQUIPMENT_CONTAINER, oldMemberOf_EquipmentContainer, memberOf_EquipmentContainer));
			}
		}
	...
	public NotificationChain basicSetMemberOf_EquipmentContainer(ConnectivityNodeContainer newMemberOf_EquipmentContainer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TopologyPackage.CONNECTIVITY_NODE__MEMBER_OF_EQUIPMENT_CONTAINER, oldMemberOf_EquipmentContainer, newMemberOf_EquipmentContainer);
	...
	public void setMemberOf_EquipmentContainer(ConnectivityNodeContainer newMemberOf_EquipmentContainer) {
		if (newMemberOf_EquipmentContainer != memberOf_EquipmentContainer) {
			...
			if (memberOf_EquipmentContainer != null)
				msgs = ((InternalEObject)memberOf_EquipmentContainer).eInverseRemove(this, CorePackage.CONNECTIVITY_NODE_CONTAINER__CONNECTIVITY_NODES, ConnectivityNodeContainer.class, msgs);
			if (newMemberOf_EquipmentContainer != null)
				msgs = ((InternalEObject)newMemberOf_EquipmentContainer).eInverseAdd(this, CorePackage.CONNECTIVITY_NODE_CONTAINER__CONNECTIVITY_NODES, ConnectivityNodeContainer.class, msgs);
			msgs = basicSetMemberOf_EquipmentContainer(newMemberOf_EquipmentContainer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TopologyPackage.CONNECTIVITY_NODE__MEMBER_OF_EQUIPMENT_CONTAINER, newMemberOf_EquipmentContainer, newMemberOf_EquipmentContainer));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case TopologyPackage.CONNECTIVITY_NODE__MEMBER_OF_EQUIPMENT_CONTAINER:
				if (memberOf_EquipmentContainer != null)
					msgs = ((InternalEObject)memberOf_EquipmentContainer).eInverseRemove(this, CorePackage.CONNECTIVITY_NODE_CONTAINER__CONNECTIVITY_NODES, ConnectivityNodeContainer.class, msgs);
