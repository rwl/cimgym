 ...
 * <ul>
 *   <li>{@link CPSM.Wires.StaticVarCompensator#getVoltageSetPoint <em>Voltage Set Point</em>}</li>
 *   <li>{@link CPSM.Wires.StaticVarCompensator#getSVCControlMode <em>SVC Control Mode</em>}</li>
 *   <li>{@link CPSM.Wires.StaticVarCompensator#getCapacitiveRating <em>Capacitive Rating</em>}</li>
 *   <li>{@link CPSM.Wires.StaticVarCompensator#getSlope <em>Slope</em>}</li>
 *   <li>{@link CPSM.Wires.StaticVarCompensator#getInductiveRating <em>Inductive Rating</em>}</li>
 * </ul>
 * </p>
 *
 * @see CPSM.Wires.WiresPackage#getStaticVarCompensator()
...
public interface StaticVarCompensator extends RegulatingCondEq {
	 ...
	 * @see CPSM.Wires.WiresPackage#getStaticVarCompensator_VoltageSetPoint()
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.StaticVarCompensator#getVoltageSetPoint <em>Voltage Set Point</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link CPSM.Wires.SVCControlMode}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Wires.WiresPackage#getStaticVarCompensator_SVCControlMode()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.StaticVarCompensator#getSVCControlMode <em>SVC Control Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.Wires.WiresPackage#getStaticVarCompensator_CapacitiveRating()
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.StaticVarCompensator#getCapacitiveRating <em>Capacitive Rating</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setSlope(double)
	 * @see CPSM.Wires.WiresPackage#getStaticVarCompensator_Slope()
	 * @model dataType="CPSM.Domain.VoltagePerReactivePower" required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.StaticVarCompensator#getSlope <em>Slope</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.Wires.WiresPackage#getStaticVarCompensator_InductiveRating()
	 * @model dataType="CPSM.Domain.Reactance" required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.StaticVarCompensator#getInductiveRating <em>Inductive Rating</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
