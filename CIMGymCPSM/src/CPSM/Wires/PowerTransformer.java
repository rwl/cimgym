 ...
 * <ul>
 *   <li>{@link CPSM.Wires.PowerTransformer#getContains_TransformerWindings <em>Contains Transformer Windings</em>}</li>
 * </ul>
 * </p>
 *
 * @see CPSM.Wires.WiresPackage#getPowerTransformer()
...
public interface PowerTransformer extends Equipment {
	 ...
	 * The list contents are of type {@link CPSM.Wires.TransformerWinding}.
	 * It is bidirectional and its opposite is '{@link CPSM.Wires.TransformerWinding#getMemberOf_PowerTransformer <em>Member Of Power Transformer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Wires.WiresPackage#getPowerTransformer_Contains_TransformerWindings()
