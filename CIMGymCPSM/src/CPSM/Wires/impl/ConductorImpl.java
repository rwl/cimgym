 ...
 * <ul>
 *   <li>{@link CPSM.Wires.impl.ConductorImpl#getR <em>R</em>}</li>
 *   <li>{@link CPSM.Wires.impl.ConductorImpl#getX <em>X</em>}</li>
 *   <li>{@link CPSM.Wires.impl.ConductorImpl#getBch <em>Bch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConductorImpl extends ConductingEquipmentImpl implements Conductor {
	...
	public void setR(double newR) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WiresPackage.CONDUCTOR__R, oldR, r));
	}
	...
	public void setX(double newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WiresPackage.CONDUCTOR__X, oldX, x));
	}
	...
	public void setBch(double newBch) {
		...
		bch = newBch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WiresPackage.CONDUCTOR__BCH, oldBch, bch));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WiresPackage.CONDUCTOR__R:
				return getR();
			case WiresPackage.CONDUCTOR__X:
				return getX();
			case WiresPackage.CONDUCTOR__BCH:
				return getBch();
		}
