 ...
 * <ul>
 *   <li>{@link CPSM.Wires.TransformerWinding#getWindingType <em>Winding Type</em>}</li>
 *   <li>{@link CPSM.Wires.TransformerWinding#getTapChangers <em>Tap Changers</em>}</li>
 *   <li>{@link CPSM.Wires.TransformerWinding#getMemberOf_PowerTransformer <em>Member Of Power Transformer</em>}</li>
 *   <li>{@link CPSM.Wires.TransformerWinding#getRatedS <em>Rated S</em>}</li>
 *   <li>{@link CPSM.Wires.TransformerWinding#getX <em>X</em>}</li>
 *   <li>{@link CPSM.Wires.TransformerWinding#getRatedU <em>Rated U</em>}</li>
 *   <li>{@link CPSM.Wires.TransformerWinding#getR <em>R</em>}</li>
 *   <li>{@link CPSM.Wires.TransformerWinding#getB <em>B</em>}</li>
 * </ul>
 * </p>
 *
 * @see CPSM.Wires.WiresPackage#getTransformerWinding()
...
public interface TransformerWinding extends ConductingEquipment {
	 ...
	 * The literals are from the enumeration {@link CPSM.Wires.WindingType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Wires.WiresPackage#getTransformerWinding_WindingType()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.TransformerWinding#getWindingType <em>Winding Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.Wires.TapChanger#getTransformerWinding <em>Transformer Winding</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Wires.WiresPackage#getTransformerWinding_TapChangers()
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.Wires.PowerTransformer#getContains_TransformerWindings <em>Contains Transformer Windings</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Wires.WiresPackage#getTransformerWinding_MemberOf_PowerTransformer()
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.TransformerWinding#getMemberOf_PowerTransformer <em>Member Of Power Transformer</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.Wires.WiresPackage#getTransformerWinding_RatedS()
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.TransformerWinding#getRatedS <em>Rated S</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setX(double)
	 * @see CPSM.Wires.WiresPackage#getTransformerWinding_X()
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.TransformerWinding#getX <em>X</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.Wires.WiresPackage#getTransformerWinding_RatedU()
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.TransformerWinding#getRatedU <em>Rated U</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setR(double)
	 * @see CPSM.Wires.WiresPackage#getTransformerWinding_R()
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.TransformerWinding#getR <em>R</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setB(double)
	 * @see CPSM.Wires.WiresPackage#getTransformerWinding_B()
	...
	/**
	 * Sets the value of the '{@link CPSM.Wires.TransformerWinding#getB <em>B</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
