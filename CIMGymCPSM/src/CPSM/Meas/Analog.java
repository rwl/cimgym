 ...
 * <ul>
 *   <li>{@link CPSM.Meas.Analog#isPositiveFlowIn <em>Positive Flow In</em>}</li>
 *   <li>{@link CPSM.Meas.Analog#getContain_MeasurementValues <em>Contain Measurement Values</em>}</li>
 * </ul>
 * </p>
 *
 * @see CPSM.Meas.MeasPackage#getAnalog()
...
public interface Analog extends Measurement {
	 ...
	 * @see CPSM.Meas.MeasPackage#getAnalog_PositiveFlowIn()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Meas.Analog#isPositiveFlowIn <em>Positive Flow In</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CPSM.Meas.AnalogValue}.
	 * It is bidirectional and its opposite is '{@link CPSM.Meas.AnalogValue#getMemberOf_Measurement <em>Member Of Measurement</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Meas.MeasPackage#getAnalog_Contain_MeasurementValues()
