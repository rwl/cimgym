 ...
 * <ul>
 *   <li>{@link CPSM.ControlArea.ControlArea#getControlAreaGeneratingUnit <em>Control Area Generating Unit</em>}</li>
 *   <li>{@link CPSM.ControlArea.ControlArea#getNetInterchange <em>Net Interchange</em>}</li>
 *   <li>{@link CPSM.ControlArea.ControlArea#getEnergyArea <em>Energy Area</em>}</li>
 *   <li>{@link CPSM.ControlArea.ControlArea#getTieFlow <em>Tie Flow</em>}</li>
 *   <li>{@link CPSM.ControlArea.ControlArea#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see CPSM.ControlArea.ControlAreaPackage#getControlArea()
...
public interface ControlArea extends PowerSystemResource {
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.ControlArea.ControlAreaGeneratingUnit#getControlArea <em>Control Area</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.ControlArea.ControlAreaPackage#getControlArea_ControlAreaGeneratingUnit()
	 ...
	 * @see CPSM.ControlArea.ControlAreaPackage#getControlArea_NetInterchange()
	...
	/**
	 * Sets the value of the '{@link CPSM.ControlArea.ControlArea#getNetInterchange <em>Net Interchange</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.LoadModel.EnergyArea#getControlArea <em>Control Area</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.ControlArea.ControlAreaPackage#getControlArea_EnergyArea()
	...
	/**
	 * Sets the value of the '{@link CPSM.ControlArea.ControlArea#getEnergyArea <em>Energy Area</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CPSM.ControlArea.TieFlow}.
	 * It is bidirectional and its opposite is '{@link CPSM.ControlArea.TieFlow#getControlArea <em>Control Area</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.ControlArea.ControlAreaPackage#getControlArea_TieFlow()
	 ...
	 * The literals are from the enumeration {@link CPSM.ControlArea.ControlAreaTypeKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.ControlArea.ControlAreaPackage#getControlArea_Type()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.ControlArea.ControlArea#getType <em>Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
