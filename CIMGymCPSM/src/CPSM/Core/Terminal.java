 ...
 * <ul>
 *   <li>{@link CPSM.Core.Terminal#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link CPSM.Core.Terminal#getRegulatingControl <em>Regulating Control</em>}</li>
 *   <li>{@link CPSM.Core.Terminal#getConnectivityNode <em>Connectivity Node</em>}</li>
 *   <li>{@link CPSM.Core.Terminal#getConductingEquipment <em>Conducting Equipment</em>}</li>
 * </ul>
 * </p>
 *
 * @see CPSM.Core.CorePackage#getTerminal()
...
public interface Terminal extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.Meas.Measurement#getTerminal <em>Terminal</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Core.CorePackage#getTerminal_Measurements()
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.Wires.RegulatingControl#getTerminal <em>Terminal</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Core.CorePackage#getTerminal_RegulatingControl()
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.Topology.ConnectivityNode#getTerminals <em>Terminals</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Core.CorePackage#getTerminal_ConnectivityNode()
	...
	/**
	 * Sets the value of the '{@link CPSM.Core.Terminal#getConnectivityNode <em>Connectivity Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.Core.ConductingEquipment#getTerminals <em>Terminals</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Core.CorePackage#getTerminal_ConductingEquipment()
	...
	/**
	 * Sets the value of the '{@link CPSM.Core.Terminal#getConductingEquipment <em>Conducting Equipment</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
