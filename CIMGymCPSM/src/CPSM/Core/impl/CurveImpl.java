 ...
 * <ul>
 *   <li>{@link CPSM.Core.impl.CurveImpl#getY2Unit <em>Y2 Unit</em>}</li>
 *   <li>{@link CPSM.Core.impl.CurveImpl#getXUnit <em>XUnit</em>}</li>
 *   <li>{@link CPSM.Core.impl.CurveImpl#getCurveScheduleDatas <em>Curve Schedule Datas</em>}</li>
 *   <li>{@link CPSM.Core.impl.CurveImpl#getCurveStyle <em>Curve Style</em>}</li>
 *   <li>{@link CPSM.Core.impl.CurveImpl#getY1Unit <em>Y1 Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CurveImpl extends IdentifiedObjectImpl implements Curve {
	...
	public EList<CurveData> getCurveScheduleDatas() {
		if (curveScheduleDatas == null) {
			curveScheduleDatas = new EObjectWithInverseResolvingEList<CurveData>(CurveData.class, this, CorePackage.CURVE__CURVE_SCHEDULE_DATAS, CorePackage.CURVE_DATA__CURVE_SCHEDULE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.CURVE__CURVE_SCHEDULE_DATAS:
