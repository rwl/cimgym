 ...
 * <ul>
 *   <li>{@link CPSM.Core.Substation#getRegion <em>Region</em>}</li>
 *   <li>{@link CPSM.Core.Substation#getContains_VoltageLevels <em>Contains Voltage Levels</em>}</li>
 * </ul>
 * </p>
 *
 * @see CPSM.Core.CorePackage#getSubstation()
...
public interface Substation extends EquipmentContainer {
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.Core.SubGeographicalRegion#getSubstations <em>Substations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Core.CorePackage#getSubstation_Region()
	...
	/**
	 * Sets the value of the '{@link CPSM.Core.Substation#getRegion <em>Region</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.Core.VoltageLevel#getMemberOf_Substation <em>Member Of Substation</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Core.CorePackage#getSubstation_Contains_VoltageLevels()
