 ...
 * <!-- end-user-doc -->
 * @see CPSM.Core.CorePackage#getCurveStyle()
 * @model
 * @generated
 */
public enum CurveStyle implements Enumerator {
	 ...
	 * @ordered
	 */
	RAMP_YVALUE(0, "rampYValue", "rampYValue"),
	 ...
	 * @ordered
	 */
	STRAIGHT_LINE_YVALUES(3, "straightLineYValues", "straightLineYValues");
	 ...
	 * @ordered
	 */
	public static final int RAMP_YVALUE_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int STRAIGHT_LINE_YVALUES_VALUE = 3;
