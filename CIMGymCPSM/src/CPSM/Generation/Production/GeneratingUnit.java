 ...
 * <ul>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getMaxOperatingP <em>Max Operating P</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getNormalPF <em>Normal PF</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getRatedGrossMaxP <em>Rated Gross Max P</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getRatedGrossMinP <em>Rated Gross Min P</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getGenControlSource <em>Gen Control Source</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getRatedNetMaxP <em>Rated Net Max P</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getLongPF <em>Long PF</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getContains_SynchronousMachines <em>Contains Synchronous Machines</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getGrossToNetActivePowerCurves <em>Gross To Net Active Power Curves</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getInitialP <em>Initial P</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getControlAreaGeneratingUnit <em>Control Area Generating Unit</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getShortPF <em>Short PF</em>}</li>
 *   <li>{@link CPSM.Generation.Production.GeneratingUnit#getMinOperatingP <em>Min Operating P</em>}</li>
 * </ul>
 * </p>
 *
 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit()
...
public interface GeneratingUnit extends Equipment {
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_MaxOperatingP()
	...
	/**
	 * Sets the value of the '{@link CPSM.Generation.Production.GeneratingUnit#getMaxOperatingP <em>Max Operating P</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_NormalPF()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Generation.Production.GeneratingUnit#getNormalPF <em>Normal PF</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_RatedGrossMaxP()
	 * @model dataType="CPSM.Domain.ActivePower" required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Generation.Production.GeneratingUnit#getRatedGrossMaxP <em>Rated Gross Max P</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_RatedGrossMinP()
	 * @model dataType="CPSM.Domain.ActivePower" required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Generation.Production.GeneratingUnit#getRatedGrossMinP <em>Rated Gross Min P</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link CPSM.Generation.Production.GeneratorControlSource}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_GenControlSource()
	...
	/**
	 * Sets the value of the '{@link CPSM.Generation.Production.GeneratingUnit#getGenControlSource <em>Gen Control Source</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_RatedNetMaxP()
	 * @model dataType="CPSM.Domain.ActivePower" required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Generation.Production.GeneratingUnit#getRatedNetMaxP <em>Rated Net Max P</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setLongPF(float)
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_LongPF()
	 * @model required="true"
	 *        annotation="http://iec.ch/TC57/2008/CIM-schema-cim13# Documentation='Generating unit economic participation factor'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel Documentation='Generating unit economic participation factor'"
	 * @generated
	...
	/**
	 * Sets the value of the '{@link CPSM.Generation.Production.GeneratingUnit#getLongPF <em>Long PF</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.Wires.SynchronousMachine#getMemberOf_GeneratingUnit <em>Member Of Generating Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_Contains_SynchronousMachines()
	 ...
	 * The list contents are of type {@link CPSM.Generation.Production.GrossToNetActivePowerCurve}.
	 * It is bidirectional and its opposite is '{@link CPSM.Generation.Production.GrossToNetActivePowerCurve#getGeneratingUnit <em>Generating Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_GrossToNetActivePowerCurves()
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_InitialP()
	 * @model dataType="CPSM.Domain.ActivePower" required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Generation.Production.GeneratingUnit#getInitialP <em>Initial P</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link CPSM.ControlArea.ControlAreaGeneratingUnit}.
	 * It is bidirectional and its opposite is '{@link CPSM.ControlArea.ControlAreaGeneratingUnit#getGeneratingUnit <em>Generating Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_ControlAreaGeneratingUnit()
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_ShortPF()
	 * @model required="true"
	 *        annotation="http://iec.ch/TC57/2008/CIM-schema-cim13# Documentation='Generating unit economic participation factor'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel Documentation='Generating unit economic participation factor'"
	 * @generated
	...
	/**
	 * Sets the value of the '{@link CPSM.Generation.Production.GeneratingUnit#getShortPF <em>Short PF</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CPSM.Generation.Production.ProductionPackage#getGeneratingUnit_MinOperatingP()
	 * @model dataType="CPSM.Domain.ActivePower" required="true"
	...
	/**
	 * Sets the value of the '{@link CPSM.Generation.Production.GeneratingUnit#getMinOperatingP <em>Min Operating P</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
