 ...
 * <ul>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getMaxOperatingP <em>Max Operating P</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getNormalPF <em>Normal PF</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getRatedGrossMaxP <em>Rated Gross Max P</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getRatedGrossMinP <em>Rated Gross Min P</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getGenControlSource <em>Gen Control Source</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getRatedNetMaxP <em>Rated Net Max P</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getLongPF <em>Long PF</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getContains_SynchronousMachines <em>Contains Synchronous Machines</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getGrossToNetActivePowerCurves <em>Gross To Net Active Power Curves</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getInitialP <em>Initial P</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getControlAreaGeneratingUnit <em>Control Area Generating Unit</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getShortPF <em>Short PF</em>}</li>
 *   <li>{@link CPSM.Generation.Production.impl.GeneratingUnitImpl#getMinOperatingP <em>Min Operating P</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneratingUnitImpl extends EquipmentImpl implements GeneratingUnit {
	...
	public EList<SynchronousMachine> getContains_SynchronousMachines() {
		if (contains_SynchronousMachines == null) {
			contains_SynchronousMachines = new EObjectWithInverseResolvingEList<SynchronousMachine>(SynchronousMachine.class, this, ProductionPackage.GENERATING_UNIT__CONTAINS_SYNCHRONOUS_MACHINES, WiresPackage.SYNCHRONOUS_MACHINE__MEMBER_OF_GENERATING_UNIT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProductionPackage.GENERATING_UNIT__CONTAINS_SYNCHRONOUS_MACHINES:
