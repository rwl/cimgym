 ...
 * <ul>
 *   <li>{@link CPSM.impl.NonConformLoadImpl#getLoadGroup <em>Load Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NonConformLoadImpl extends EnergyConsumerImpl implements NonConformLoad {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.NON_CONFORM_LOAD;
	}
		...
		if (loadGroup != null && loadGroup.eIsProxy()) {
			...
			if (loadGroup != oldLoadGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.NON_CONFORM_LOAD__LOAD_GROUP, oldLoadGroup, loadGroup));
			}
		}
		return loadGroup;
	}
	...
	public NotificationChain basicSetLoadGroup(NonConformLoadGroup newLoadGroup, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.NON_CONFORM_LOAD__LOAD_GROUP, oldLoadGroup, newLoadGroup);
	...
	public void setLoadGroup(NonConformLoadGroup newLoadGroup) {
		if (newLoadGroup != loadGroup) {
			...
			if (loadGroup != null)
				msgs = ((InternalEObject)loadGroup).eInverseRemove(this, CPSMPackage.NON_CONFORM_LOAD_GROUP__ENERGY_CONSUMERS, NonConformLoadGroup.class, msgs);
			if (newLoadGroup != null)
				msgs = ((InternalEObject)newLoadGroup).eInverseAdd(this, CPSMPackage.NON_CONFORM_LOAD_GROUP__ENERGY_CONSUMERS, NonConformLoadGroup.class, msgs);
			msgs = basicSetLoadGroup(newLoadGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.NON_CONFORM_LOAD__LOAD_GROUP, newLoadGroup, newLoadGroup));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.NON_CONFORM_LOAD__LOAD_GROUP:
				if (loadGroup != null)
					msgs = ((InternalEObject)loadGroup).eInverseRemove(this, CPSMPackage.NON_CONFORM_LOAD_GROUP__ENERGY_CONSUMERS, NonConformLoadGroup.class, msgs);
