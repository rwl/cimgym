 ...
 * <ul>
 *   <li>{@link CPSM.impl.SeasonImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link CPSM.impl.SeasonImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link CPSM.impl.SeasonImpl#getSeasonDayTypeSchedules <em>Season Day Type Schedules</em>}</li>
 *   <li>{@link CPSM.impl.SeasonImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SeasonImpl extends ElementImpl implements Season {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.SEASON;
	}
	...
	public void setEndDate(Date newEndDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.SEASON__END_DATE, oldEndDate, endDate));
	}
	...
	public void setStartDate(Date newStartDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.SEASON__START_DATE, oldStartDate, startDate));
	}
	...
	public EList<SeasonDayTypeSchedule> getSeasonDayTypeSchedules() {
		if (seasonDayTypeSchedules == null) {
			seasonDayTypeSchedules = new EObjectWithInverseResolvingEList<SeasonDayTypeSchedule>(SeasonDayTypeSchedule.class, this, CPSMPackage.SEASON__SEASON_DAY_TYPE_SCHEDULES, CPSMPackage.SEASON_DAY_TYPE_SCHEDULE__SEASON);
		}
	...
	public void setName(SeasonName newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.SEASON__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.SEASON__SEASON_DAY_TYPE_SCHEDULES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CPSMPackage.SEASON__END_DATE:
				return getEndDate();
			case CPSMPackage.SEASON__START_DATE:
				return getStartDate();
			case CPSMPackage.SEASON__SEASON_DAY_TYPE_SCHEDULES:
				return getSeasonDayTypeSchedules();
			case CPSMPackage.SEASON__NAME:
				return getName();
		}
