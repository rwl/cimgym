 ...
 * <ul>
 *   <li>{@link CPSM.impl.ConformLoadScheduleImpl#getConformLoadGroup <em>Conform Load Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConformLoadScheduleImpl extends SeasonDayTypeScheduleImpl implements ConformLoadSchedule {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.CONFORM_LOAD_SCHEDULE;
	}
		...
		if (conformLoadGroup != null && conformLoadGroup.eIsProxy()) {
			...
			if (conformLoadGroup != oldConformLoadGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.CONFORM_LOAD_SCHEDULE__CONFORM_LOAD_GROUP, oldConformLoadGroup, conformLoadGroup));
			}
		}
	...
	public NotificationChain basicSetConformLoadGroup(ConformLoadGroup newConformLoadGroup, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.CONFORM_LOAD_SCHEDULE__CONFORM_LOAD_GROUP, oldConformLoadGroup, newConformLoadGroup);
	...
	public void setConformLoadGroup(ConformLoadGroup newConformLoadGroup) {
		if (newConformLoadGroup != conformLoadGroup) {
			...
			if (conformLoadGroup != null)
				msgs = ((InternalEObject)conformLoadGroup).eInverseRemove(this, CPSMPackage.CONFORM_LOAD_GROUP__CONFORM_LOAD_SCHEDULES, ConformLoadGroup.class, msgs);
			if (newConformLoadGroup != null)
				msgs = ((InternalEObject)newConformLoadGroup).eInverseAdd(this, CPSMPackage.CONFORM_LOAD_GROUP__CONFORM_LOAD_SCHEDULES, ConformLoadGroup.class, msgs);
			msgs = basicSetConformLoadGroup(newConformLoadGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.CONFORM_LOAD_SCHEDULE__CONFORM_LOAD_GROUP, newConformLoadGroup, newConformLoadGroup));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.CONFORM_LOAD_SCHEDULE__CONFORM_LOAD_GROUP:
				if (conformLoadGroup != null)
					msgs = ((InternalEObject)conformLoadGroup).eInverseRemove(this, CPSMPackage.CONFORM_LOAD_GROUP__CONFORM_LOAD_SCHEDULES, ConformLoadGroup.class, msgs);
