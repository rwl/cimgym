 ...
 * <ul>
 *   <li>{@link CPSM.impl.VoltageLevelImpl#getMemberOf_Substation <em>Member Of Substation</em>}</li>
 *   <li>{@link CPSM.impl.VoltageLevelImpl#getLowVoltageLimit <em>Low Voltage Limit</em>}</li>
 *   <li>{@link CPSM.impl.VoltageLevelImpl#getHighVoltageLimit <em>High Voltage Limit</em>}</li>
 *   <li>{@link CPSM.impl.VoltageLevelImpl#getBaseVoltage <em>Base Voltage</em>}</li>
 *   <li>{@link CPSM.impl.VoltageLevelImpl#getContains_Bays <em>Contains Bays</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VoltageLevelImpl extends EquipmentContainerImpl implements VoltageLevel {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.VOLTAGE_LEVEL;
	}
		...
		if (memberOf_Substation != null && memberOf_Substation.eIsProxy()) {
			...
			if (memberOf_Substation != oldMemberOf_Substation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.VOLTAGE_LEVEL__MEMBER_OF_SUBSTATION, oldMemberOf_Substation, memberOf_Substation));
			}
		}
	...
	public NotificationChain basicSetMemberOf_Substation(Substation newMemberOf_Substation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.VOLTAGE_LEVEL__MEMBER_OF_SUBSTATION, oldMemberOf_Substation, newMemberOf_Substation);
	...
	public void setMemberOf_Substation(Substation newMemberOf_Substation) {
		if (newMemberOf_Substation != memberOf_Substation) {
			...
			if (memberOf_Substation != null)
				msgs = ((InternalEObject)memberOf_Substation).eInverseRemove(this, CPSMPackage.SUBSTATION__CONTAINS_VOLTAGE_LEVELS, Substation.class, msgs);
			if (newMemberOf_Substation != null)
				msgs = ((InternalEObject)newMemberOf_Substation).eInverseAdd(this, CPSMPackage.SUBSTATION__CONTAINS_VOLTAGE_LEVELS, Substation.class, msgs);
			msgs = basicSetMemberOf_Substation(newMemberOf_Substation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.VOLTAGE_LEVEL__MEMBER_OF_SUBSTATION, newMemberOf_Substation, newMemberOf_Substation));
	}
	...
	public void setLowVoltageLimit(double newLowVoltageLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.VOLTAGE_LEVEL__LOW_VOLTAGE_LIMIT, oldLowVoltageLimit, lowVoltageLimit));
	}
	...
	public void setHighVoltageLimit(double newHighVoltageLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.VOLTAGE_LEVEL__HIGH_VOLTAGE_LIMIT, oldHighVoltageLimit, highVoltageLimit));
	}
	...
	public BaseVoltage getBaseVoltage() {
		if (baseVoltage != null && baseVoltage.eIsProxy()) {
			...
			if (baseVoltage != oldBaseVoltage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.VOLTAGE_LEVEL__BASE_VOLTAGE, oldBaseVoltage, baseVoltage));
			}
		}
		return baseVoltage;
	}
	...
	public NotificationChain basicSetBaseVoltage(BaseVoltage newBaseVoltage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.VOLTAGE_LEVEL__BASE_VOLTAGE, oldBaseVoltage, newBaseVoltage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBaseVoltage(BaseVoltage newBaseVoltage) {
		if (newBaseVoltage != baseVoltage) {
			NotificationChain msgs = null;
			if (baseVoltage != null)
				msgs = ((InternalEObject)baseVoltage).eInverseRemove(this, CPSMPackage.BASE_VOLTAGE__VOLTAGE_LEVEL, BaseVoltage.class, msgs);
			if (newBaseVoltage != null)
				msgs = ((InternalEObject)newBaseVoltage).eInverseAdd(this, CPSMPackage.BASE_VOLTAGE__VOLTAGE_LEVEL, BaseVoltage.class, msgs);
			msgs = basicSetBaseVoltage(newBaseVoltage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.VOLTAGE_LEVEL__BASE_VOLTAGE, newBaseVoltage, newBaseVoltage));
	}
	...
	public EList<Bay> getContains_Bays() {
		if (contains_Bays == null) {
			contains_Bays = new EObjectWithInverseResolvingEList<Bay>(Bay.class, this, CPSMPackage.VOLTAGE_LEVEL__CONTAINS_BAYS, CPSMPackage.BAY__MEMBER_OF_VOLTAGE_LEVEL);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.VOLTAGE_LEVEL__MEMBER_OF_SUBSTATION:
				if (memberOf_Substation != null)
					msgs = ((InternalEObject)memberOf_Substation).eInverseRemove(this, CPSMPackage.SUBSTATION__CONTAINS_VOLTAGE_LEVELS, Substation.class, msgs);
				return basicSetMemberOf_Substation((Substation)otherEnd, msgs);
			case CPSMPackage.VOLTAGE_LEVEL__BASE_VOLTAGE:
				if (baseVoltage != null)
					msgs = ((InternalEObject)baseVoltage).eInverseRemove(this, CPSMPackage.BASE_VOLTAGE__VOLTAGE_LEVEL, BaseVoltage.class, msgs);
				return basicSetBaseVoltage((BaseVoltage)otherEnd, msgs);
			case CPSMPackage.VOLTAGE_LEVEL__CONTAINS_BAYS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CPSMPackage.VOLTAGE_LEVEL__LOW_VOLTAGE_LIMIT:
				return getLowVoltageLimit();
			case CPSMPackage.VOLTAGE_LEVEL__HIGH_VOLTAGE_LIMIT:
