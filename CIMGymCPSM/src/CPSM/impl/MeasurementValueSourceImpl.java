 ...
 * <ul>
 *   <li>{@link CPSM.impl.MeasurementValueSourceImpl#getMeasurementValues <em>Measurement Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MeasurementValueSourceImpl extends IdentifiedObjectImpl implements MeasurementValueSource {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.MEASUREMENT_VALUE_SOURCE;
	}
	...
	public EList<MeasurementValue> getMeasurementValues() {
		if (measurementValues == null) {
			measurementValues = new EObjectWithInverseResolvingEList<MeasurementValue>(MeasurementValue.class, this, CPSMPackage.MEASUREMENT_VALUE_SOURCE__MEASUREMENT_VALUES, CPSMPackage.MEASUREMENT_VALUE__MEASUREMENT_VALUE_SOURCE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.MEASUREMENT_VALUE_SOURCE__MEASUREMENT_VALUES:
