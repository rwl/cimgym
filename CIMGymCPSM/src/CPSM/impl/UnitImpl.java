 ...
 * <ul>
 *   <li>{@link CPSM.impl.UnitImpl#getMeasurements <em>Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitImpl extends IdentifiedObjectImpl implements Unit {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.UNIT;
	}
	...
	public EList<Measurement> getMeasurements() {
		if (measurements == null) {
			measurements = new EObjectWithInverseResolvingEList<Measurement>(Measurement.class, this, CPSMPackage.UNIT__MEASUREMENTS, CPSMPackage.MEASUREMENT__UNIT);
		}
		return measurements;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.UNIT__MEASUREMENTS:
