 ...
 * <ul>
 *   <li>{@link CPSM.impl.ConformLoadImpl#getLoadGroup <em>Load Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConformLoadImpl extends EnergyConsumerImpl implements ConformLoad {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.CONFORM_LOAD;
	}
		...
		if (loadGroup != null && loadGroup.eIsProxy()) {
			...
			if (loadGroup != oldLoadGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.CONFORM_LOAD__LOAD_GROUP, oldLoadGroup, loadGroup));
			}
		}
		return loadGroup;
	}
	...
	public NotificationChain basicSetLoadGroup(ConformLoadGroup newLoadGroup, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.CONFORM_LOAD__LOAD_GROUP, oldLoadGroup, newLoadGroup);
	...
	public void setLoadGroup(ConformLoadGroup newLoadGroup) {
		if (newLoadGroup != loadGroup) {
			...
			if (loadGroup != null)
				msgs = ((InternalEObject)loadGroup).eInverseRemove(this, CPSMPackage.CONFORM_LOAD_GROUP__ENERGY_CONSUMERS, ConformLoadGroup.class, msgs);
			if (newLoadGroup != null)
				msgs = ((InternalEObject)newLoadGroup).eInverseAdd(this, CPSMPackage.CONFORM_LOAD_GROUP__ENERGY_CONSUMERS, ConformLoadGroup.class, msgs);
			msgs = basicSetLoadGroup(newLoadGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.CONFORM_LOAD__LOAD_GROUP, newLoadGroup, newLoadGroup));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.CONFORM_LOAD__LOAD_GROUP:
				if (loadGroup != null)
					msgs = ((InternalEObject)loadGroup).eInverseRemove(this, CPSMPackage.CONFORM_LOAD_GROUP__ENERGY_CONSUMERS, ConformLoadGroup.class, msgs);
