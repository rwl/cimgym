 ...
 * <ul>
 *   <li>{@link CPSM.impl.AnalogValueImpl#getMemberOf_Measurement <em>Member Of Measurement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnalogValueImpl extends MeasurementValueImpl implements AnalogValue {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.ANALOG_VALUE;
	}
		...
		if (memberOf_Measurement != null && memberOf_Measurement.eIsProxy()) {
			...
			if (memberOf_Measurement != oldMemberOf_Measurement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.ANALOG_VALUE__MEMBER_OF_MEASUREMENT, oldMemberOf_Measurement, memberOf_Measurement));
			}
		}
	...
	public NotificationChain basicSetMemberOf_Measurement(Analog newMemberOf_Measurement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.ANALOG_VALUE__MEMBER_OF_MEASUREMENT, oldMemberOf_Measurement, newMemberOf_Measurement);
	...
	public void setMemberOf_Measurement(Analog newMemberOf_Measurement) {
		if (newMemberOf_Measurement != memberOf_Measurement) {
			...
			if (memberOf_Measurement != null)
				msgs = ((InternalEObject)memberOf_Measurement).eInverseRemove(this, CPSMPackage.ANALOG__CONTAIN_MEASUREMENT_VALUES, Analog.class, msgs);
			if (newMemberOf_Measurement != null)
				msgs = ((InternalEObject)newMemberOf_Measurement).eInverseAdd(this, CPSMPackage.ANALOG__CONTAIN_MEASUREMENT_VALUES, Analog.class, msgs);
			msgs = basicSetMemberOf_Measurement(newMemberOf_Measurement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.ANALOG_VALUE__MEMBER_OF_MEASUREMENT, newMemberOf_Measurement, newMemberOf_Measurement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.ANALOG_VALUE__MEMBER_OF_MEASUREMENT:
				if (memberOf_Measurement != null)
					msgs = ((InternalEObject)memberOf_Measurement).eInverseRemove(this, CPSMPackage.ANALOG__CONTAIN_MEASUREMENT_VALUES, Analog.class, msgs);
