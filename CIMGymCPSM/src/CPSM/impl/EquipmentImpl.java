 ...
 * <ul>
 *   <li>{@link CPSM.impl.EquipmentImpl#getMemberOf_EquipmentContainer <em>Member Of Equipment Container</em>}</li>
 *   <li>{@link CPSM.impl.EquipmentImpl#getOperationalLimitSet <em>Operational Limit Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EquipmentImpl extends PowerSystemResourceImpl implements Equipment {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.EQUIPMENT;
	}
		...
		if (memberOf_EquipmentContainer != null && memberOf_EquipmentContainer.eIsProxy()) {
			...
			if (memberOf_EquipmentContainer != oldMemberOf_EquipmentContainer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.EQUIPMENT__MEMBER_OF_EQUIPMENT_CONTAINER, oldMemberOf_EquipmentContainer, memberOf_EquipmentContainer));
			}
		}
	...
	public NotificationChain basicSetMemberOf_EquipmentContainer(EquipmentContainer newMemberOf_EquipmentContainer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.EQUIPMENT__MEMBER_OF_EQUIPMENT_CONTAINER, oldMemberOf_EquipmentContainer, newMemberOf_EquipmentContainer);
	...
	public void setMemberOf_EquipmentContainer(EquipmentContainer newMemberOf_EquipmentContainer) {
		if (newMemberOf_EquipmentContainer != memberOf_EquipmentContainer) {
			...
			if (memberOf_EquipmentContainer != null)
				msgs = ((InternalEObject)memberOf_EquipmentContainer).eInverseRemove(this, CPSMPackage.EQUIPMENT_CONTAINER__CONTAINS_EQUIPMENTS, EquipmentContainer.class, msgs);
			if (newMemberOf_EquipmentContainer != null)
				msgs = ((InternalEObject)newMemberOf_EquipmentContainer).eInverseAdd(this, CPSMPackage.EQUIPMENT_CONTAINER__CONTAINS_EQUIPMENTS, EquipmentContainer.class, msgs);
			msgs = basicSetMemberOf_EquipmentContainer(newMemberOf_EquipmentContainer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.EQUIPMENT__MEMBER_OF_EQUIPMENT_CONTAINER, newMemberOf_EquipmentContainer, newMemberOf_EquipmentContainer));
	}
	...
	public EList<OperationalLimitSet> getOperationalLimitSet() {
		if (operationalLimitSet == null) {
			operationalLimitSet = new EObjectWithInverseResolvingEList<OperationalLimitSet>(OperationalLimitSet.class, this, CPSMPackage.EQUIPMENT__OPERATIONAL_LIMIT_SET, CPSMPackage.OPERATIONAL_LIMIT_SET__EQUIPMENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.EQUIPMENT__MEMBER_OF_EQUIPMENT_CONTAINER:
				if (memberOf_EquipmentContainer != null)
					msgs = ((InternalEObject)memberOf_EquipmentContainer).eInverseRemove(this, CPSMPackage.EQUIPMENT_CONTAINER__CONTAINS_EQUIPMENTS, EquipmentContainer.class, msgs);
				return basicSetMemberOf_EquipmentContainer((EquipmentContainer)otherEnd, msgs);
			case CPSMPackage.EQUIPMENT__OPERATIONAL_LIMIT_SET:
