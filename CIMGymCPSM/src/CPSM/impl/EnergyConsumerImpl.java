 ...
 * <ul>
 *   <li>{@link CPSM.impl.EnergyConsumerImpl#getQfixedPct <em>Qfixed Pct</em>}</li>
 *   <li>{@link CPSM.impl.EnergyConsumerImpl#getPfixed <em>Pfixed</em>}</li>
 *   <li>{@link CPSM.impl.EnergyConsumerImpl#getLoadResponse <em>Load Response</em>}</li>
 *   <li>{@link CPSM.impl.EnergyConsumerImpl#getQfixed <em>Qfixed</em>}</li>
 *   <li>{@link CPSM.impl.EnergyConsumerImpl#getPfixedPct <em>Pfixed Pct</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EnergyConsumerImpl extends ConductingEquipmentImpl implements EnergyConsumer {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.ENERGY_CONSUMER;
	}
	...
	public void setQfixedPct(double newQfixedPct) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.ENERGY_CONSUMER__QFIXED_PCT, oldQfixedPct, qfixedPct));
	}
	...
	public void setPfixed(double newPfixed) {
		...
		pfixed = newPfixed;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.ENERGY_CONSUMER__PFIXED, oldPfixed, pfixed));
	}
	...
	public LoadResponseCharacteristic getLoadResponse() {
		if (loadResponse != null && loadResponse.eIsProxy()) {
			...
			if (loadResponse != oldLoadResponse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.ENERGY_CONSUMER__LOAD_RESPONSE, oldLoadResponse, loadResponse));
			}
		}
		return loadResponse;
	}
	...
	public NotificationChain basicSetLoadResponse(LoadResponseCharacteristic newLoadResponse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.ENERGY_CONSUMER__LOAD_RESPONSE, oldLoadResponse, newLoadResponse);
	...
	public void setLoadResponse(LoadResponseCharacteristic newLoadResponse) {
		if (newLoadResponse != loadResponse) {
			...
			if (loadResponse != null)
				msgs = ((InternalEObject)loadResponse).eInverseRemove(this, CPSMPackage.LOAD_RESPONSE_CHARACTERISTIC__ENERGY_CONSUMER, LoadResponseCharacteristic.class, msgs);
			if (newLoadResponse != null)
				msgs = ((InternalEObject)newLoadResponse).eInverseAdd(this, CPSMPackage.LOAD_RESPONSE_CHARACTERISTIC__ENERGY_CONSUMER, LoadResponseCharacteristic.class, msgs);
			msgs = basicSetLoadResponse(newLoadResponse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.ENERGY_CONSUMER__LOAD_RESPONSE, newLoadResponse, newLoadResponse));
	}
	...
	public void setQfixed(double newQfixed) {
		...
		qfixed = newQfixed;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.ENERGY_CONSUMER__QFIXED, oldQfixed, qfixed));
	}
	...
	public void setPfixedPct(double newPfixedPct) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.ENERGY_CONSUMER__PFIXED_PCT, oldPfixedPct, pfixedPct));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.ENERGY_CONSUMER__LOAD_RESPONSE:
				if (loadResponse != null)
					msgs = ((InternalEObject)loadResponse).eInverseRemove(this, CPSMPackage.LOAD_RESPONSE_CHARACTERISTIC__ENERGY_CONSUMER, LoadResponseCharacteristic.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CPSMPackage.ENERGY_CONSUMER__QFIXED_PCT:
				return getQfixedPct();
			case CPSMPackage.ENERGY_CONSUMER__PFIXED:
				return getPfixed();
			case CPSMPackage.ENERGY_CONSUMER__LOAD_RESPONSE:
				if (resolve) return getLoadResponse();
				return basicGetLoadResponse();
			case CPSMPackage.ENERGY_CONSUMER__QFIXED:
				return getQfixed();
			case CPSMPackage.ENERGY_CONSUMER__PFIXED_PCT:
				return getPfixedPct();
		}
