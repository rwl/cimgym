 ...
 * <ul>
 *   <li>{@link CPSM.impl.NonConformLoadScheduleImpl#getNonConformLoadGroup <em>Non Conform Load Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NonConformLoadScheduleImpl extends SeasonDayTypeScheduleImpl implements NonConformLoadSchedule {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.NON_CONFORM_LOAD_SCHEDULE;
	}
		...
		if (nonConformLoadGroup != null && nonConformLoadGroup.eIsProxy()) {
			...
			if (nonConformLoadGroup != oldNonConformLoadGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.NON_CONFORM_LOAD_SCHEDULE__NON_CONFORM_LOAD_GROUP, oldNonConformLoadGroup, nonConformLoadGroup));
			}
		}
	...
	public NotificationChain basicSetNonConformLoadGroup(NonConformLoadGroup newNonConformLoadGroup, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.NON_CONFORM_LOAD_SCHEDULE__NON_CONFORM_LOAD_GROUP, oldNonConformLoadGroup, newNonConformLoadGroup);
	...
	public void setNonConformLoadGroup(NonConformLoadGroup newNonConformLoadGroup) {
		if (newNonConformLoadGroup != nonConformLoadGroup) {
			...
			if (nonConformLoadGroup != null)
				msgs = ((InternalEObject)nonConformLoadGroup).eInverseRemove(this, CPSMPackage.NON_CONFORM_LOAD_GROUP__NON_CONFORM_LOAD_SCHEDULES, NonConformLoadGroup.class, msgs);
			if (newNonConformLoadGroup != null)
				msgs = ((InternalEObject)newNonConformLoadGroup).eInverseAdd(this, CPSMPackage.NON_CONFORM_LOAD_GROUP__NON_CONFORM_LOAD_SCHEDULES, NonConformLoadGroup.class, msgs);
			msgs = basicSetNonConformLoadGroup(newNonConformLoadGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.NON_CONFORM_LOAD_SCHEDULE__NON_CONFORM_LOAD_GROUP, newNonConformLoadGroup, newNonConformLoadGroup));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.NON_CONFORM_LOAD_SCHEDULE__NON_CONFORM_LOAD_GROUP:
				if (nonConformLoadGroup != null)
					msgs = ((InternalEObject)nonConformLoadGroup).eInverseRemove(this, CPSMPackage.NON_CONFORM_LOAD_GROUP__NON_CONFORM_LOAD_SCHEDULES, NonConformLoadGroup.class, msgs);
