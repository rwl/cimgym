 ...
 * <ul>
 *   <li>{@link CPSM.PowerSystemResource#getContains_Measurements <em>Contains Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @see CPSM.CPSMPackage#getPowerSystemResource()
 * @model abstract="true"
...
public interface PowerSystemResource extends IdentifiedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link CPSM.Measurement#getMemberOf_PSR <em>Member Of PSR</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see CPSM.CPSMPackage#getPowerSystemResource_Contains_Measurements()
