 ...
 * <ul>
 *   <li>{@link CPSM.impl.CurveDataImpl#getY2value <em>Y2value</em>}</li>
 *   <li>{@link CPSM.impl.CurveDataImpl#getXvalue <em>Xvalue</em>}</li>
 *   <li>{@link CPSM.impl.CurveDataImpl#getY1value <em>Y1value</em>}</li>
 *   <li>{@link CPSM.impl.CurveDataImpl#getCurveSchedule <em>Curve Schedule</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CurveDataImpl extends ElementImpl implements CurveData {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.CURVE_DATA;
	}
	...
	public void setY2value(float newY2value) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.CURVE_DATA__Y2VALUE, oldY2value, y2value));
	}
	...
	public void setXvalue(float newXvalue) {
		...
		xvalue = newXvalue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.CURVE_DATA__XVALUE, oldXvalue, xvalue));
	}
	...
	public void setY1value(float newY1value) {
		...
		y1value = newY1value;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.CURVE_DATA__Y1VALUE, oldY1value, y1value));
	}
	...
	public Curve getCurveSchedule() {
		if (curveSchedule != null && curveSchedule.eIsProxy()) {
			...
			if (curveSchedule != oldCurveSchedule) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.CURVE_DATA__CURVE_SCHEDULE, oldCurveSchedule, curveSchedule));
			}
		}
	...
	public NotificationChain basicSetCurveSchedule(Curve newCurveSchedule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.CURVE_DATA__CURVE_SCHEDULE, oldCurveSchedule, newCurveSchedule);
	...
	public void setCurveSchedule(Curve newCurveSchedule) {
		if (newCurveSchedule != curveSchedule) {
			...
			if (curveSchedule != null)
				msgs = ((InternalEObject)curveSchedule).eInverseRemove(this, CPSMPackage.CURVE__CURVE_SCHEDULE_DATAS, Curve.class, msgs);
			if (newCurveSchedule != null)
				msgs = ((InternalEObject)newCurveSchedule).eInverseAdd(this, CPSMPackage.CURVE__CURVE_SCHEDULE_DATAS, Curve.class, msgs);
			msgs = basicSetCurveSchedule(newCurveSchedule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.CURVE_DATA__CURVE_SCHEDULE, newCurveSchedule, newCurveSchedule));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.CURVE_DATA__CURVE_SCHEDULE:
				if (curveSchedule != null)
					msgs = ((InternalEObject)curveSchedule).eInverseRemove(this, CPSMPackage.CURVE__CURVE_SCHEDULE_DATAS, Curve.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CPSMPackage.CURVE_DATA__Y2VALUE:
				return getY2value();
			case CPSMPackage.CURVE_DATA__XVALUE:
				return getXvalue();
			case CPSMPackage.CURVE_DATA__Y1VALUE:
				return getY1value();
			case CPSMPackage.CURVE_DATA__CURVE_SCHEDULE:
