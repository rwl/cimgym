 ...
 * <ul>
 *   <li>{@link CPSM.impl.TapChangerImpl#getRegulatingControl <em>Regulating Control</em>}</li>
 *   <li>{@link CPSM.impl.TapChangerImpl#getTransformerWinding <em>Transformer Winding</em>}</li>
 *   <li>{@link CPSM.impl.TapChangerImpl#getNormalStep <em>Normal Step</em>}</li>
 *   <li>{@link CPSM.impl.TapChangerImpl#getHighStep <em>High Step</em>}</li>
 *   <li>{@link CPSM.impl.TapChangerImpl#getStepPhaseShiftIncrement <em>Step Phase Shift Increment</em>}</li>
 *   <li>{@link CPSM.impl.TapChangerImpl#getNeutralStep <em>Neutral Step</em>}</li>
 *   <li>{@link CPSM.impl.TapChangerImpl#getLowStep <em>Low Step</em>}</li>
 *   <li>{@link CPSM.impl.TapChangerImpl#getTculControlMode <em>Tcul Control Mode</em>}</li>
 *   <li>{@link CPSM.impl.TapChangerImpl#getStepVoltageIncrement <em>Step Voltage Increment</em>}</li>
 *   <li>{@link CPSM.impl.TapChangerImpl#getType <em>Type</em>}</li>
 *   <li>{@link CPSM.impl.TapChangerImpl#getNeutralU <em>Neutral U</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TapChangerImpl extends PowerSystemResourceImpl implements TapChanger {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.TAP_CHANGER;
	}
		...
		if (regulatingControl != null && regulatingControl.eIsProxy()) {
			...
			if (regulatingControl != oldRegulatingControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.TAP_CHANGER__REGULATING_CONTROL, oldRegulatingControl, regulatingControl));
			}
		}
	...
	public NotificationChain basicSetRegulatingControl(RegulatingControl newRegulatingControl, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__REGULATING_CONTROL, oldRegulatingControl, newRegulatingControl);
	...
	public void setRegulatingControl(RegulatingControl newRegulatingControl) {
		if (newRegulatingControl != regulatingControl) {
			...
			if (regulatingControl != null)
				msgs = ((InternalEObject)regulatingControl).eInverseRemove(this, CPSMPackage.REGULATING_CONTROL__TAP_CHANGER, RegulatingControl.class, msgs);
			if (newRegulatingControl != null)
				msgs = ((InternalEObject)newRegulatingControl).eInverseAdd(this, CPSMPackage.REGULATING_CONTROL__TAP_CHANGER, RegulatingControl.class, msgs);
			msgs = basicSetRegulatingControl(newRegulatingControl, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__REGULATING_CONTROL, newRegulatingControl, newRegulatingControl));
	}
	...
	public TransformerWinding getTransformerWinding() {
		if (transformerWinding != null && transformerWinding.eIsProxy()) {
			...
			if (transformerWinding != oldTransformerWinding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.TAP_CHANGER__TRANSFORMER_WINDING, oldTransformerWinding, transformerWinding));
			}
		}
	...
	public NotificationChain basicSetTransformerWinding(TransformerWinding newTransformerWinding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__TRANSFORMER_WINDING, oldTransformerWinding, newTransformerWinding);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTransformerWinding(TransformerWinding newTransformerWinding) {
		if (newTransformerWinding != transformerWinding) {
			...
			if (transformerWinding != null)
				msgs = ((InternalEObject)transformerWinding).eInverseRemove(this, CPSMPackage.TRANSFORMER_WINDING__TAP_CHANGERS, TransformerWinding.class, msgs);
			if (newTransformerWinding != null)
				msgs = ((InternalEObject)newTransformerWinding).eInverseAdd(this, CPSMPackage.TRANSFORMER_WINDING__TAP_CHANGERS, TransformerWinding.class, msgs);
			msgs = basicSetTransformerWinding(newTransformerWinding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__TRANSFORMER_WINDING, newTransformerWinding, newTransformerWinding));
	}
	...
	public void setNormalStep(int newNormalStep) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__NORMAL_STEP, oldNormalStep, normalStep));
	}
	...
	public void setHighStep(int newHighStep) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__HIGH_STEP, oldHighStep, highStep));
	}
	...
	public void setStepPhaseShiftIncrement(double newStepPhaseShiftIncrement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__STEP_PHASE_SHIFT_INCREMENT, oldStepPhaseShiftIncrement, stepPhaseShiftIncrement));
	}
	...
	public void setNeutralStep(int newNeutralStep) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__NEUTRAL_STEP, oldNeutralStep, neutralStep));
	}
	...
	public void setLowStep(int newLowStep) {
		...
		lowStep = newLowStep;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__LOW_STEP, oldLowStep, lowStep));
	}
	...
	public void setTculControlMode(TransformerControlMode newTculControlMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__TCUL_CONTROL_MODE, oldTculControlMode, tculControlMode));
	}
	...
	public void setStepVoltageIncrement(double newStepVoltageIncrement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__STEP_VOLTAGE_INCREMENT, oldStepVoltageIncrement, stepVoltageIncrement));
	}
	...
	public void setType(TapChangerKind newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__TYPE, oldType, type));
	}
	...
	public void setNeutralU(double newNeutralU) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TAP_CHANGER__NEUTRAL_U, oldNeutralU, neutralU));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.TAP_CHANGER__REGULATING_CONTROL:
				if (regulatingControl != null)
					msgs = ((InternalEObject)regulatingControl).eInverseRemove(this, CPSMPackage.REGULATING_CONTROL__TAP_CHANGER, RegulatingControl.class, msgs);
				return basicSetRegulatingControl((RegulatingControl)otherEnd, msgs);
			case CPSMPackage.TAP_CHANGER__TRANSFORMER_WINDING:
				if (transformerWinding != null)
					msgs = ((InternalEObject)transformerWinding).eInverseRemove(this, CPSMPackage.TRANSFORMER_WINDING__TAP_CHANGERS, TransformerWinding.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CPSMPackage.TAP_CHANGER__NORMAL_STEP:
				return getNormalStep();
			case CPSMPackage.TAP_CHANGER__HIGH_STEP:
				return getHighStep();
			case CPSMPackage.TAP_CHANGER__STEP_PHASE_SHIFT_INCREMENT:
				return getStepPhaseShiftIncrement();
			case CPSMPackage.TAP_CHANGER__NEUTRAL_STEP:
				return getNeutralStep();
			case CPSMPackage.TAP_CHANGER__LOW_STEP:
				return getLowStep();
			case CPSMPackage.TAP_CHANGER__TCUL_CONTROL_MODE:
				return getTculControlMode();
			case CPSMPackage.TAP_CHANGER__STEP_VOLTAGE_INCREMENT:
				return getStepVoltageIncrement();
			case CPSMPackage.TAP_CHANGER__TYPE:
				return getType();
			case CPSMPackage.TAP_CHANGER__NEUTRAL_U:
				return getNeutralU();
		}
