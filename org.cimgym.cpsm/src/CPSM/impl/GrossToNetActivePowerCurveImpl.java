 ...
 * <ul>
 *   <li>{@link CPSM.impl.GrossToNetActivePowerCurveImpl#getGeneratingUnit <em>Generating Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GrossToNetActivePowerCurveImpl extends CurveImpl implements GrossToNetActivePowerCurve {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.GROSS_TO_NET_ACTIVE_POWER_CURVE;
	}
		...
		if (generatingUnit != null && generatingUnit.eIsProxy()) {
			...
			if (generatingUnit != oldGeneratingUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.GROSS_TO_NET_ACTIVE_POWER_CURVE__GENERATING_UNIT, oldGeneratingUnit, generatingUnit));
			}
		}
	...
	public NotificationChain basicSetGeneratingUnit(GeneratingUnit newGeneratingUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.GROSS_TO_NET_ACTIVE_POWER_CURVE__GENERATING_UNIT, oldGeneratingUnit, newGeneratingUnit);
	...
	public void setGeneratingUnit(GeneratingUnit newGeneratingUnit) {
		if (newGeneratingUnit != generatingUnit) {
			...
			if (generatingUnit != null)
				msgs = ((InternalEObject)generatingUnit).eInverseRemove(this, CPSMPackage.GENERATING_UNIT__GROSS_TO_NET_ACTIVE_POWER_CURVES, GeneratingUnit.class, msgs);
			if (newGeneratingUnit != null)
				msgs = ((InternalEObject)newGeneratingUnit).eInverseAdd(this, CPSMPackage.GENERATING_UNIT__GROSS_TO_NET_ACTIVE_POWER_CURVES, GeneratingUnit.class, msgs);
			msgs = basicSetGeneratingUnit(newGeneratingUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.GROSS_TO_NET_ACTIVE_POWER_CURVE__GENERATING_UNIT, newGeneratingUnit, newGeneratingUnit));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.GROSS_TO_NET_ACTIVE_POWER_CURVE__GENERATING_UNIT:
				if (generatingUnit != null)
					msgs = ((InternalEObject)generatingUnit).eInverseRemove(this, CPSMPackage.GENERATING_UNIT__GROSS_TO_NET_ACTIVE_POWER_CURVES, GeneratingUnit.class, msgs);
