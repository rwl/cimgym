 ...
 * <ul>
 *   <li>{@link CPSM.impl.LoadAreaImpl#getSubLoadAreas <em>Sub Load Areas</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LoadAreaImpl extends EnergyAreaImpl implements LoadArea {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.LOAD_AREA;
	}
	...
	public EList<SubLoadArea> getSubLoadAreas() {
		if (subLoadAreas == null) {
			subLoadAreas = new EObjectWithInverseResolvingEList<SubLoadArea>(SubLoadArea.class, this, CPSMPackage.LOAD_AREA__SUB_LOAD_AREAS, CPSMPackage.SUB_LOAD_AREA__LOAD_AREA);
		}
		return subLoadAreas;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.LOAD_AREA__SUB_LOAD_AREAS:
