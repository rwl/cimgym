 ...
 * <ul>
 *   <li>{@link CPSM.impl.RegularIntervalScheduleImpl#getEndTime <em>End Time</em>}</li>
 *   <li>{@link CPSM.impl.RegularIntervalScheduleImpl#getTimePoints <em>Time Points</em>}</li>
 *   <li>{@link CPSM.impl.RegularIntervalScheduleImpl#getTimeStep <em>Time Step</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RegularIntervalScheduleImpl extends BasicIntervalScheduleImpl implements RegularIntervalSchedule {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.REGULAR_INTERVAL_SCHEDULE;
	}
	...
	public void setEndTime(Date newEndTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.REGULAR_INTERVAL_SCHEDULE__END_TIME, oldEndTime, endTime));
	}
	...
	public EList<RegularTimePoint> getTimePoints() {
		if (timePoints == null) {
			timePoints = new EObjectWithInverseResolvingEList<RegularTimePoint>(RegularTimePoint.class, this, CPSMPackage.REGULAR_INTERVAL_SCHEDULE__TIME_POINTS, CPSMPackage.REGULAR_TIME_POINT__INTERVAL_SCHEDULE);
		}
		return timePoints;
	}
	...
	public void setTimeStep(double newTimeStep) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.REGULAR_INTERVAL_SCHEDULE__TIME_STEP, oldTimeStep, timeStep));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.REGULAR_INTERVAL_SCHEDULE__TIME_POINTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CPSMPackage.REGULAR_INTERVAL_SCHEDULE__END_TIME:
				return getEndTime();
			case CPSMPackage.REGULAR_INTERVAL_SCHEDULE__TIME_POINTS:
				return getTimePoints();
			case CPSMPackage.REGULAR_INTERVAL_SCHEDULE__TIME_STEP:
				return getTimeStep();
		}
