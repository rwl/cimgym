 ...
 * <ul>
 *   <li>{@link CPSM.impl.PowerTransformerImpl#getContains_TransformerWindings <em>Contains Transformer Windings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PowerTransformerImpl extends EquipmentImpl implements PowerTransformer {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.POWER_TRANSFORMER;
	}
	...
	public EList<TransformerWinding> getContains_TransformerWindings() {
		if (contains_TransformerWindings == null) {
			contains_TransformerWindings = new EObjectWithInverseResolvingEList<TransformerWinding>(TransformerWinding.class, this, CPSMPackage.POWER_TRANSFORMER__CONTAINS_TRANSFORMER_WINDINGS, CPSMPackage.TRANSFORMER_WINDING__MEMBER_OF_POWER_TRANSFORMER);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.POWER_TRANSFORMER__CONTAINS_TRANSFORMER_WINDINGS:
