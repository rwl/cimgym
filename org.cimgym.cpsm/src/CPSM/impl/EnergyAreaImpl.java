 ...
 * <ul>
 *   <li>{@link CPSM.impl.EnergyAreaImpl#getControlArea <em>Control Area</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EnergyAreaImpl extends IdentifiedObjectImpl implements EnergyArea {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.ENERGY_AREA;
	}
		...
		if (controlArea != null && controlArea.eIsProxy()) {
			...
			if (controlArea != oldControlArea) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.ENERGY_AREA__CONTROL_AREA, oldControlArea, controlArea));
			}
		}
		return controlArea;
	}
	...
	public NotificationChain basicSetControlArea(ControlArea newControlArea, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.ENERGY_AREA__CONTROL_AREA, oldControlArea, newControlArea);
	...
	public void setControlArea(ControlArea newControlArea) {
		if (newControlArea != controlArea) {
			...
			if (controlArea != null)
				msgs = ((InternalEObject)controlArea).eInverseRemove(this, CPSMPackage.CONTROL_AREA__ENERGY_AREA, ControlArea.class, msgs);
			if (newControlArea != null)
				msgs = ((InternalEObject)newControlArea).eInverseAdd(this, CPSMPackage.CONTROL_AREA__ENERGY_AREA, ControlArea.class, msgs);
			msgs = basicSetControlArea(newControlArea, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.ENERGY_AREA__CONTROL_AREA, newControlArea, newControlArea));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.ENERGY_AREA__CONTROL_AREA:
				if (controlArea != null)
					msgs = ((InternalEObject)controlArea).eInverseRemove(this, CPSMPackage.CONTROL_AREA__ENERGY_AREA, ControlArea.class, msgs);
