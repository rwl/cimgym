 ...
 * <ul>
 *   <li>{@link CPSM.impl.NonConformLoadGroupImpl#getNonConformLoadSchedules <em>Non Conform Load Schedules</em>}</li>
 *   <li>{@link CPSM.impl.NonConformLoadGroupImpl#getEnergyConsumers <em>Energy Consumers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NonConformLoadGroupImpl extends LoadGroupImpl implements NonConformLoadGroup {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.NON_CONFORM_LOAD_GROUP;
	}
	...
	public EList<NonConformLoadSchedule> getNonConformLoadSchedules() {
		if (nonConformLoadSchedules == null) {
			nonConformLoadSchedules = new EObjectWithInverseResolvingEList<NonConformLoadSchedule>(NonConformLoadSchedule.class, this, CPSMPackage.NON_CONFORM_LOAD_GROUP__NON_CONFORM_LOAD_SCHEDULES, CPSMPackage.NON_CONFORM_LOAD_SCHEDULE__NON_CONFORM_LOAD_GROUP);
		}
	...
	public EList<NonConformLoad> getEnergyConsumers() {
		if (energyConsumers == null) {
			energyConsumers = new EObjectWithInverseResolvingEList<NonConformLoad>(NonConformLoad.class, this, CPSMPackage.NON_CONFORM_LOAD_GROUP__ENERGY_CONSUMERS, CPSMPackage.NON_CONFORM_LOAD__LOAD_GROUP);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.NON_CONFORM_LOAD_GROUP__NON_CONFORM_LOAD_SCHEDULES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getNonConformLoadSchedules()).basicAdd(otherEnd, msgs);
			case CPSMPackage.NON_CONFORM_LOAD_GROUP__ENERGY_CONSUMERS:
