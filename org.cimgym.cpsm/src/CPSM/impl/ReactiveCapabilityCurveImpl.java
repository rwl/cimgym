 ...
 * <ul>
 *   <li>{@link CPSM.impl.ReactiveCapabilityCurveImpl#getInitiallyUsedBySynchronousMachine <em>Initially Used By Synchronous Machine</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReactiveCapabilityCurveImpl extends CurveImpl implements ReactiveCapabilityCurve {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.REACTIVE_CAPABILITY_CURVE;
	}
	...
	public EList<SynchronousMachine> getInitiallyUsedBySynchronousMachine() {
		if (initiallyUsedBySynchronousMachine == null) {
			initiallyUsedBySynchronousMachine = new EObjectWithInverseResolvingEList<SynchronousMachine>(SynchronousMachine.class, this, CPSMPackage.REACTIVE_CAPABILITY_CURVE__INITIALLY_USED_BY_SYNCHRONOUS_MACHINE, CPSMPackage.SYNCHRONOUS_MACHINE__INITIAL_REACTIVE_CAPABILITY_CURVE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.REACTIVE_CAPABILITY_CURVE__INITIALLY_USED_BY_SYNCHRONOUS_MACHINE:
