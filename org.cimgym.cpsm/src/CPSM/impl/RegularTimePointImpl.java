 ...
 * <ul>
 *   <li>{@link CPSM.impl.RegularTimePointImpl#getValue1 <em>Value1</em>}</li>
 *   <li>{@link CPSM.impl.RegularTimePointImpl#getSequenceNumber <em>Sequence Number</em>}</li>
 *   <li>{@link CPSM.impl.RegularTimePointImpl#getValue2 <em>Value2</em>}</li>
 *   <li>{@link CPSM.impl.RegularTimePointImpl#getIntervalSchedule <em>Interval Schedule</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RegularTimePointImpl extends ElementImpl implements RegularTimePoint {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.REGULAR_TIME_POINT;
	}
	...
	public void setValue1(float newValue1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.REGULAR_TIME_POINT__VALUE1, oldValue1, value1));
	}
	...
	public void setSequenceNumber(int newSequenceNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.REGULAR_TIME_POINT__SEQUENCE_NUMBER, oldSequenceNumber, sequenceNumber));
	}
	...
	public void setValue2(float newValue2) {
		...
		value2 = newValue2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.REGULAR_TIME_POINT__VALUE2, oldValue2, value2));
	}
	...
	public RegularIntervalSchedule getIntervalSchedule() {
		if (intervalSchedule != null && intervalSchedule.eIsProxy()) {
			...
			if (intervalSchedule != oldIntervalSchedule) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.REGULAR_TIME_POINT__INTERVAL_SCHEDULE, oldIntervalSchedule, intervalSchedule));
			}
		}
	...
	public NotificationChain basicSetIntervalSchedule(RegularIntervalSchedule newIntervalSchedule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.REGULAR_TIME_POINT__INTERVAL_SCHEDULE, oldIntervalSchedule, newIntervalSchedule);
	...
	public void setIntervalSchedule(RegularIntervalSchedule newIntervalSchedule) {
		if (newIntervalSchedule != intervalSchedule) {
			...
			if (intervalSchedule != null)
				msgs = ((InternalEObject)intervalSchedule).eInverseRemove(this, CPSMPackage.REGULAR_INTERVAL_SCHEDULE__TIME_POINTS, RegularIntervalSchedule.class, msgs);
			if (newIntervalSchedule != null)
				msgs = ((InternalEObject)newIntervalSchedule).eInverseAdd(this, CPSMPackage.REGULAR_INTERVAL_SCHEDULE__TIME_POINTS, RegularIntervalSchedule.class, msgs);
			msgs = basicSetIntervalSchedule(newIntervalSchedule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.REGULAR_TIME_POINT__INTERVAL_SCHEDULE, newIntervalSchedule, newIntervalSchedule));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.REGULAR_TIME_POINT__INTERVAL_SCHEDULE:
				if (intervalSchedule != null)
					msgs = ((InternalEObject)intervalSchedule).eInverseRemove(this, CPSMPackage.REGULAR_INTERVAL_SCHEDULE__TIME_POINTS, RegularIntervalSchedule.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CPSMPackage.REGULAR_TIME_POINT__VALUE1:
				return getValue1();
			case CPSMPackage.REGULAR_TIME_POINT__SEQUENCE_NUMBER:
				return getSequenceNumber();
			case CPSMPackage.REGULAR_TIME_POINT__VALUE2:
				return getValue2();
			case CPSMPackage.REGULAR_TIME_POINT__INTERVAL_SCHEDULE:
