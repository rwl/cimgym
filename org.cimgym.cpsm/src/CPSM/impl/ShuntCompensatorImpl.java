 ...
 * <ul>
 *   <li>{@link CPSM.impl.ShuntCompensatorImpl#getMaximumSections <em>Maximum Sections</em>}</li>
 *   <li>{@link CPSM.impl.ShuntCompensatorImpl#getNormalSections <em>Normal Sections</em>}</li>
 *   <li>{@link CPSM.impl.ShuntCompensatorImpl#getNomU <em>Nom U</em>}</li>
 *   <li>{@link CPSM.impl.ShuntCompensatorImpl#getReactivePerSection <em>Reactive Per Section</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ShuntCompensatorImpl extends RegulatingCondEqImpl implements ShuntCompensator {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.SHUNT_COMPENSATOR;
	}
	...
	public void setMaximumSections(int newMaximumSections) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.SHUNT_COMPENSATOR__MAXIMUM_SECTIONS, oldMaximumSections, maximumSections));
	}
	...
	public void setNormalSections(int newNormalSections) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.SHUNT_COMPENSATOR__NORMAL_SECTIONS, oldNormalSections, normalSections));
	}
	...
	public void setNomU(double newNomU) {
		...
		nomU = newNomU;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.SHUNT_COMPENSATOR__NOM_U, oldNomU, nomU));
	}
	...
	public void setReactivePerSection(double newReactivePerSection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.SHUNT_COMPENSATOR__REACTIVE_PER_SECTION, oldReactivePerSection, reactivePerSection));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CPSMPackage.SHUNT_COMPENSATOR__MAXIMUM_SECTIONS:
				return getMaximumSections();
			case CPSMPackage.SHUNT_COMPENSATOR__NORMAL_SECTIONS:
				return getNormalSections();
			case CPSMPackage.SHUNT_COMPENSATOR__NOM_U:
				return getNomU();
			case CPSMPackage.SHUNT_COMPENSATOR__REACTIVE_PER_SECTION:
