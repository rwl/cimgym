 ...
 * <ul>
 *   <li>{@link CPSM.impl.TransformerWindingImpl#getWindingType <em>Winding Type</em>}</li>
 *   <li>{@link CPSM.impl.TransformerWindingImpl#getTapChangers <em>Tap Changers</em>}</li>
 *   <li>{@link CPSM.impl.TransformerWindingImpl#getMemberOf_PowerTransformer <em>Member Of Power Transformer</em>}</li>
 *   <li>{@link CPSM.impl.TransformerWindingImpl#getRatedS <em>Rated S</em>}</li>
 *   <li>{@link CPSM.impl.TransformerWindingImpl#getX <em>X</em>}</li>
 *   <li>{@link CPSM.impl.TransformerWindingImpl#getRatedU <em>Rated U</em>}</li>
 *   <li>{@link CPSM.impl.TransformerWindingImpl#getR <em>R</em>}</li>
 *   <li>{@link CPSM.impl.TransformerWindingImpl#getB <em>B</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransformerWindingImpl extends ConductingEquipmentImpl implements TransformerWinding {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.TRANSFORMER_WINDING;
	}
	...
	public void setWindingType(WindingType newWindingType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TRANSFORMER_WINDING__WINDING_TYPE, oldWindingType, windingType));
	}
	...
	public EList<TapChanger> getTapChangers() {
		if (tapChangers == null) {
			tapChangers = new EObjectWithInverseResolvingEList<TapChanger>(TapChanger.class, this, CPSMPackage.TRANSFORMER_WINDING__TAP_CHANGERS, CPSMPackage.TAP_CHANGER__TRANSFORMER_WINDING);
		}
		return tapChangers;
	}
	...
	public PowerTransformer getMemberOf_PowerTransformer() {
		if (memberOf_PowerTransformer != null && memberOf_PowerTransformer.eIsProxy()) {
			...
			if (memberOf_PowerTransformer != oldMemberOf_PowerTransformer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.TRANSFORMER_WINDING__MEMBER_OF_POWER_TRANSFORMER, oldMemberOf_PowerTransformer, memberOf_PowerTransformer));
			}
		}
	...
	public NotificationChain basicSetMemberOf_PowerTransformer(PowerTransformer newMemberOf_PowerTransformer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.TRANSFORMER_WINDING__MEMBER_OF_POWER_TRANSFORMER, oldMemberOf_PowerTransformer, newMemberOf_PowerTransformer);
	...
	public void setMemberOf_PowerTransformer(PowerTransformer newMemberOf_PowerTransformer) {
		if (newMemberOf_PowerTransformer != memberOf_PowerTransformer) {
			...
			if (memberOf_PowerTransformer != null)
				msgs = ((InternalEObject)memberOf_PowerTransformer).eInverseRemove(this, CPSMPackage.POWER_TRANSFORMER__CONTAINS_TRANSFORMER_WINDINGS, PowerTransformer.class, msgs);
			if (newMemberOf_PowerTransformer != null)
				msgs = ((InternalEObject)newMemberOf_PowerTransformer).eInverseAdd(this, CPSMPackage.POWER_TRANSFORMER__CONTAINS_TRANSFORMER_WINDINGS, PowerTransformer.class, msgs);
			msgs = basicSetMemberOf_PowerTransformer(newMemberOf_PowerTransformer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TRANSFORMER_WINDING__MEMBER_OF_POWER_TRANSFORMER, newMemberOf_PowerTransformer, newMemberOf_PowerTransformer));
	}
	...
	public void setRatedS(double newRatedS) {
		...
		ratedS = newRatedS;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TRANSFORMER_WINDING__RATED_S, oldRatedS, ratedS));
	}
	...
	public void setX(double newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TRANSFORMER_WINDING__X, oldX, x));
	}
	...
	public void setRatedU(double newRatedU) {
		...
		ratedU = newRatedU;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TRANSFORMER_WINDING__RATED_U, oldRatedU, ratedU));
	}
	...
	public void setR(double newR) {
		...
		r = newR;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TRANSFORMER_WINDING__R, oldR, r));
	}
	...
	public void setB(double newB) {
		...
		b = newB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.TRANSFORMER_WINDING__B, oldB, b));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.TRANSFORMER_WINDING__TAP_CHANGERS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTapChangers()).basicAdd(otherEnd, msgs);
			case CPSMPackage.TRANSFORMER_WINDING__MEMBER_OF_POWER_TRANSFORMER:
				if (memberOf_PowerTransformer != null)
					msgs = ((InternalEObject)memberOf_PowerTransformer).eInverseRemove(this, CPSMPackage.POWER_TRANSFORMER__CONTAINS_TRANSFORMER_WINDINGS, PowerTransformer.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CPSMPackage.TRANSFORMER_WINDING__WINDING_TYPE:
			...
			case CPSMPackage.TRANSFORMER_WINDING__RATED_S:
				return getRatedS();
			case CPSMPackage.TRANSFORMER_WINDING__X:
				return getX();
			case CPSMPackage.TRANSFORMER_WINDING__RATED_U:
				return getRatedU();
			case CPSMPackage.TRANSFORMER_WINDING__R:
				return getR();
			case CPSMPackage.TRANSFORMER_WINDING__B:
				return getB();
		}
