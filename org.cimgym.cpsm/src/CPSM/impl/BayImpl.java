 ...
 * <ul>
 *   <li>{@link CPSM.impl.BayImpl#getMemberOf_VoltageLevel <em>Member Of Voltage Level</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BayImpl extends EquipmentContainerImpl implements Bay {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.BAY;
	}
		...
		if (memberOf_VoltageLevel != null && memberOf_VoltageLevel.eIsProxy()) {
			...
			if (memberOf_VoltageLevel != oldMemberOf_VoltageLevel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.BAY__MEMBER_OF_VOLTAGE_LEVEL, oldMemberOf_VoltageLevel, memberOf_VoltageLevel));
			}
		}
	...
	public NotificationChain basicSetMemberOf_VoltageLevel(VoltageLevel newMemberOf_VoltageLevel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.BAY__MEMBER_OF_VOLTAGE_LEVEL, oldMemberOf_VoltageLevel, newMemberOf_VoltageLevel);
	...
	public void setMemberOf_VoltageLevel(VoltageLevel newMemberOf_VoltageLevel) {
		if (newMemberOf_VoltageLevel != memberOf_VoltageLevel) {
			...
			if (memberOf_VoltageLevel != null)
				msgs = ((InternalEObject)memberOf_VoltageLevel).eInverseRemove(this, CPSMPackage.VOLTAGE_LEVEL__CONTAINS_BAYS, VoltageLevel.class, msgs);
			if (newMemberOf_VoltageLevel != null)
				msgs = ((InternalEObject)newMemberOf_VoltageLevel).eInverseAdd(this, CPSMPackage.VOLTAGE_LEVEL__CONTAINS_BAYS, VoltageLevel.class, msgs);
			msgs = basicSetMemberOf_VoltageLevel(newMemberOf_VoltageLevel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.BAY__MEMBER_OF_VOLTAGE_LEVEL, newMemberOf_VoltageLevel, newMemberOf_VoltageLevel));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.BAY__MEMBER_OF_VOLTAGE_LEVEL:
				if (memberOf_VoltageLevel != null)
					msgs = ((InternalEObject)memberOf_VoltageLevel).eInverseRemove(this, CPSMPackage.VOLTAGE_LEVEL__CONTAINS_BAYS, VoltageLevel.class, msgs);
