 ...
 * <ul>
 *   <li>{@link CPSM.impl.IdentifiedObjectImpl#getPathName <em>Path Name</em>}</li>
 *   <li>{@link CPSM.impl.IdentifiedObjectImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link CPSM.impl.IdentifiedObjectImpl#getAliasName <em>Alias Name</em>}</li>
 *   <li>{@link CPSM.impl.IdentifiedObjectImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class IdentifiedObjectImpl extends ElementImpl implements IdentifiedObject {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.IDENTIFIED_OBJECT;
	}
	...
	public void setPathName(String newPathName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.IDENTIFIED_OBJECT__PATH_NAME, oldPathName, pathName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.IDENTIFIED_OBJECT__DESCRIPTION, oldDescription, description));
	}
	...
	public void setAliasName(String newAliasName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.IDENTIFIED_OBJECT__ALIAS_NAME, oldAliasName, aliasName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.IDENTIFIED_OBJECT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CPSMPackage.IDENTIFIED_OBJECT__PATH_NAME:
				return getPathName();
			case CPSMPackage.IDENTIFIED_OBJECT__DESCRIPTION:
				return getDescription();
			case CPSMPackage.IDENTIFIED_OBJECT__ALIAS_NAME:
				return getAliasName();
			case CPSMPackage.IDENTIFIED_OBJECT__NAME:
				return getName();
		}
