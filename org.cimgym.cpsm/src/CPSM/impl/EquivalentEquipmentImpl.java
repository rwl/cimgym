 ...
 * <ul>
 *   <li>{@link CPSM.impl.EquivalentEquipmentImpl#getEquivalentNetwork <em>Equivalent Network</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EquivalentEquipmentImpl extends ConductingEquipmentImpl implements EquivalentEquipment {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.EQUIVALENT_EQUIPMENT;
	}
		...
		if (equivalentNetwork != null && equivalentNetwork.eIsProxy()) {
			...
			if (equivalentNetwork != oldEquivalentNetwork) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CPSMPackage.EQUIVALENT_EQUIPMENT__EQUIVALENT_NETWORK, oldEquivalentNetwork, equivalentNetwork));
			}
		}
	...
	public NotificationChain basicSetEquivalentNetwork(EquivalentNetwork newEquivalentNetwork, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPSMPackage.EQUIVALENT_EQUIPMENT__EQUIVALENT_NETWORK, oldEquivalentNetwork, newEquivalentNetwork);
	...
	public void setEquivalentNetwork(EquivalentNetwork newEquivalentNetwork) {
		if (newEquivalentNetwork != equivalentNetwork) {
			...
			if (equivalentNetwork != null)
				msgs = ((InternalEObject)equivalentNetwork).eInverseRemove(this, CPSMPackage.EQUIVALENT_NETWORK__EQUIVALENT_EQUIPMENTS, EquivalentNetwork.class, msgs);
			if (newEquivalentNetwork != null)
				msgs = ((InternalEObject)newEquivalentNetwork).eInverseAdd(this, CPSMPackage.EQUIVALENT_NETWORK__EQUIVALENT_EQUIPMENTS, EquivalentNetwork.class, msgs);
			msgs = basicSetEquivalentNetwork(newEquivalentNetwork, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPSMPackage.EQUIVALENT_EQUIPMENT__EQUIVALENT_NETWORK, newEquivalentNetwork, newEquivalentNetwork));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.EQUIVALENT_EQUIPMENT__EQUIVALENT_NETWORK:
				if (equivalentNetwork != null)
					msgs = ((InternalEObject)equivalentNetwork).eInverseRemove(this, CPSMPackage.EQUIVALENT_NETWORK__EQUIVALENT_EQUIPMENTS, EquivalentNetwork.class, msgs);
