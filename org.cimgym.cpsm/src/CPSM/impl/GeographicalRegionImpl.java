 ...
 * <ul>
 *   <li>{@link CPSM.impl.GeographicalRegionImpl#getRegions <em>Regions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeographicalRegionImpl extends IdentifiedObjectImpl implements GeographicalRegion {
	...
	protected EClass eStaticClass() {
		return CPSMPackage.Literals.GEOGRAPHICAL_REGION;
	}
	...
	public EList<SubGeographicalRegion> getRegions() {
		if (regions == null) {
			regions = new EObjectWithInverseResolvingEList<SubGeographicalRegion>(SubGeographicalRegion.class, this, CPSMPackage.GEOGRAPHICAL_REGION__REGIONS, CPSMPackage.SUB_GEOGRAPHICAL_REGION__REGION);
		}
		return regions;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CPSMPackage.GEOGRAPHICAL_REGION__REGIONS:
