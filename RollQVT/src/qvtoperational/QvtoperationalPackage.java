...
public interface QvtoperationalPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int IMPERATIVE_OPERATION__IS_BLACKBOX = EmofPackage.OPERATION_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int RESOLVE_EXP__TAG = EssentialoclPackage.CALL_EXP__TAG;
	 ...
	 * @ordered
	 */
	int RESOLVE_EXP__ONE = EssentialoclPackage.CALL_EXP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESOLVE_EXP__IS_INVERSE = EssentialoclPackage.CALL_EXP_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESOLVE_EXP__IS_DEFERRED = EssentialoclPackage.CALL_EXP_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RESOLVE_EXP__TARGET = EssentialoclPackage.CALL_EXP_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int RESOLVE_EXP__CONDITION = EssentialoclPackage.CALL_EXP_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int RESOLVE_IN_EXP__TAG = RESOLVE_EXP__TAG;
	 ...
	 * @ordered
	 */
	int MODULE__TAG = EmofPackage.CLASS__TAG;
	 ...
	 * @ordered
	 */
	int MODULE__OWNED_TYPE = EmofPackage.CLASS_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MODULE__NESTED_PACKAGE = EmofPackage.CLASS_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int MODULE__OWNED_TAG = EmofPackage.CLASS_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int MODULE__CONFIG_PROPERTY = EmofPackage.CLASS_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int MODULE__USED_MODEL_TYPE = EmofPackage.CLASS_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int MODULE__IS_BLACKBOX = EmofPackage.CLASS_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int VAR_PARAMETER__INIT_EXPRESSION = EmofPackage.PARAMETER_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int VAR_PARAMETER__LET_EXP = EmofPackage.PARAMETER_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int VAR_PARAMETER__BIND_PARAMETER = EmofPackage.PARAMETER_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int VAR_PARAMETER__CTX_OWNER = EmofPackage.PARAMETER_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int VAR_PARAMETER__RES_OWNER = EmofPackage.PARAMETER_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int VAR_PARAMETER__KIND = EmofPackage.PARAMETER_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int VAR_PARAMETER_FEATURE_COUNT = EmofPackage.PARAMETER_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int MAPPING_PARAMETER__BIND_PARAMETER = VAR_PARAMETER__BIND_PARAMETER;
	 ...
	 * @ordered
	 */
	int MAPPING_OPERATION__REFINED_RELATION = IMPERATIVE_OPERATION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int IMPERATIVE_CALL_EXP__TAG = EssentialoclPackage.OPERATION_CALL_EXP__TAG;
	 ...
	 * @ordered
	 */
	int MAPPING_CALL_EXP__TAG = IMPERATIVE_CALL_EXP__TAG;
	 ...
	 * @ordered
	 */
	int CONTEXTUAL_PROPERTY__TAG = EmofPackage.PROPERTY__TAG;
	 ...
	 * @ordered
	 */
	int CONTEXTUAL_PROPERTY__OVERRIDDEN = EmofPackage.PROPERTY_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CONTEXTUAL_PROPERTY__INIT_EXPRESSION = EmofPackage.PROPERTY_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int MODEL_PARAMETER__BIND_PARAMETER = VAR_PARAMETER__BIND_PARAMETER;
	 ...
	 * @ordered
	 */
	int MODEL_TYPE__TAG = EmofPackage.CLASS__TAG;
	 ...
	 * @ordered
	 */
	int MODEL_TYPE__METAMODEL = EmofPackage.CLASS_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MODEL_TYPE__ADDITIONAL_CONDITION = EmofPackage.CLASS_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int MODEL_TYPE__CONFORMANCE_KIND = EmofPackage.CLASS_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int OBJECT_EXP__TAG = ImperativeoclPackage.INSTANTIATION_EXP__TAG;
	...
	/**
	 * Returns the meta object for the reference '{@link qvtoperational.ContextualProperty#getContext <em>Context</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Context</em>'.
	 * @see qvtoperational.ContextualProperty#getContext()
	...
	/**
	 * Returns the meta object for the reference '{@link qvtoperational.ContextualProperty#getOverridden <em>Overridden</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Overridden</em>'.
	 * @see qvtoperational.ContextualProperty#getOverridden()
	 * @see #getContextualProperty()
	 * @generated
	 */
