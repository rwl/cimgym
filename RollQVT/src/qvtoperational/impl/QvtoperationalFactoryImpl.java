...
public class QvtoperationalFactoryImpl extends EFactoryImpl implements QvtoperationalFactory {
	...
	public static QvtoperationalFactory init() {
		try {
			QvtoperationalFactory theQvtoperationalFactory = (QvtoperationalFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.schema.omg.org/spec/QVT/1.0/qvtoperational"); 
