...
public class ImperativeoclFactoryImpl extends EFactoryImpl implements ImperativeoclFactory {
	...
	public static ImperativeoclFactory init() {
		try {
			ImperativeoclFactory theImperativeoclFactory = (ImperativeoclFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.schema.omg.org/spec/QVT/1.0/imperativeocl"); 
