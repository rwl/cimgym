...
public class EssentialoclFactoryImpl extends EFactoryImpl implements EssentialoclFactory {
	...
	public static EssentialoclFactory init() {
		try {
			EssentialoclFactory theEssentialoclFactory = (EssentialoclFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.schema.omg.org/spec/OCL/2.0/essentialocl"); 
