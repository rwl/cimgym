...
public class RelationImpl extends RuleImpl implements Relation {
	...
	public EList<RelationImplementation> getOperationalImpl() {
		if (operationalImpl == null) {
			operationalImpl = new EObjectWithInverseResolvingEList<RelationImplementation>(RelationImplementation.class, this, QvtrelationPackage.RELATION__OPERATIONAL_IMPL, QvtrelationPackage.RELATION_IMPLEMENTATION__RELATION);
		}
