 ...
 * <ul>
 *   <li>{@link emof.impl.PropertyImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link emof.impl.PropertyImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link emof.impl.PropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link emof.impl.PropertyImpl#getType <em>Type</em>}</li>
