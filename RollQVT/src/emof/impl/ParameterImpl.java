 ...
 * <ul>
 *   <li>{@link emof.impl.ParameterImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link emof.impl.ParameterImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link emof.impl.ParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link emof.impl.ParameterImpl#getType <em>Type</em>}</li>
