 ...
 * <ul>
 *   <li>{@link emof.impl.OperationImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link emof.impl.OperationImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link emof.impl.OperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link emof.impl.OperationImpl#getType <em>Type</em>}</li>
